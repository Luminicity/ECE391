...
uint32_t FILESYS_START; //BIG IMPORTANT
...
void refreshbuffer(int32_t num);

int32_t printf(int8_t *format, ...);
void putc(uint8_t c);
void putccolor(uint8_t c, uint8_t delta);
void putccolorpos(uint8_t c, uint8_t delta, uint8_t x, uint8_t y);
uint8_t getScreenX();
uint8_t getScreenY();
